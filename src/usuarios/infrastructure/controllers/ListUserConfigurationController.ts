...
export class GetUserConfigByIdController {
    constructor(readonly getUserConfigByIdUseCase: GetUserConfigByIdUseCase) {}
    ...
    async run(req: Request, res: Response) {
        try {
            ...
            const getUserById = await this.getUserConfigByIdUseCase.run(userId);
