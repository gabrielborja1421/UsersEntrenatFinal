...
exports.GetUserConfigByIdController = void 0;
class GetUserConfigByIdController {
    constructor(getUserConfigByIdUseCase) {
        this.getUserConfigByIdUseCase = getUserConfigByIdUseCase;
    }
    run(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const getUserById = yield this.getUserConfigByIdUseCase.run(userId);
...
exports.GetUserConfigByIdController = GetUserConfigByIdController;
